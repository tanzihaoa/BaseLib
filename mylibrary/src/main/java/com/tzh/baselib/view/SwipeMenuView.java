...
public class SwipeMenuView extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        //LogUtils.d(TAG, "onMeasure() called with: " + "widthMeasureSpec = [" + widthMeasureSpec + "], heightMeasureSpec = [" + heightMeasureSpec + "]");
        ...
        //LogUtils.d(TAG, "onMeasure() called with: " + "mRightMenuWidths = [" + mRightMenuWidths);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        //LogUtils.d(TAG, "onLayout() called with: " + "maxScrollGap = [" + maxScrollGap + "], l = [" + l + "], t = [" + t + "], r = [" + r + "], b = [" + b + "]");
    }
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
        //LogUtils.d(TAG, "smoothExpand() called" + this);
    ...
    public void smoothClose() {
        //LogUtils.d(TAG, "smoothClose() called" + this);
