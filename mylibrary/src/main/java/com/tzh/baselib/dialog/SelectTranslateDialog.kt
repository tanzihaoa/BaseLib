package com.tzh.baselib.dialog
...
import com.tzh.baselib.adapter.MyWheelAdapter
import com.tzh.baselib.base.BaseBindingDialog
import com.tzh.baselib.databinding.DialogSelectTranslateBinding
...
class SelectTranslateDialog(val mContext : Context, val listener : SelectTranslateListener) : BaseBindingDialog<DialogSelectTranslateBinding>(mContext, R.layout.dialog_select_translate){
    ...
    override fun initView() {
        ...
        binding.wheelViewFrom.adapter = com.tzh.baselib.adapter.MyWheelAdapter(getList(true))
        ...
        binding.wheelViewTo.adapter = com.tzh.baselib.adapter.MyWheelAdapter(getList(false))
