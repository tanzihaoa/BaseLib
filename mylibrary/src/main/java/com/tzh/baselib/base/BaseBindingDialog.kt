...
import com.tzh.baselib.util.AppKtx
import com.tzh.baselib.util.Util
...
abstract class BaseBindingDialog<B : ViewDataBinding> @JvmOverloads constructor(
     ...
     * dialog 宽
     */
    var windowWidth = (com.tzh.baselib.util.Util.getPhoneWidth(context) * 0.85f).toInt()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (windowAnim == ANIM_BOTTOM) {
            setContentView(LinearLayout(context).apply {
                ...
                }, com.tzh.baselib.util.Util.getPhoneWidth(context), context.dpToPx(topViewHeight))
                if (isNeedInput) {
...
//        val heightPixels = outMetrics.heightPixels
        if (outMetrics.heightPixels == com.tzh.baselib.util.Util.getPhoneHeight(context)) {
