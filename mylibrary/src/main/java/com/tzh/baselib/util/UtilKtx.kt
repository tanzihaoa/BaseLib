...
fun Context?.spToPx(spValue: Float): Int {
    val fontScale: Float = this?.resources?.displayMetrics?.scaledDensity.toDefault(0f)
...
fun Context?.dpToPx(dpValue: Float): Int {
    val scale: Float = this?.resources?.displayMetrics?.density.toDefault(0f)
...
fun Context?.pxToDp(pxValue: Float): Int {
    val scale = this?.resources?.displayMetrics?.density.toDefault(0f)
