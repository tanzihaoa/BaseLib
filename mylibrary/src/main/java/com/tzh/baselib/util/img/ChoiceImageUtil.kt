...
object ChoiceImageUtil {
    ...
    fun getList(adapter : ChoiceImageAdapter) : MutableList<com.tzh.baselib.util.img.ImageDTO>{
        val list: MutableList<com.tzh.baselib.util.img.ImageDTO> = adapter.getList()
        if (list.isNotEmpty()) {
