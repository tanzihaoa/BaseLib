package com.tzh.baselib.util.picture
...
object PictureSelectorHelper {
    ...
    fun onPicturePreview(activity: Activity, position: Int, images: MutableList<LocalMedia>) {
        PictureSelector.create(activity)
            .openPreview()
            .setImageEngine(com.tzh.baselib.util.picture.GlideEngine.createGlideEngine()) // 请参考Demo GlideEngine.java
    ...
    fun onPictureSelector(
        ...
        val selectionModel = PictureSelector.create(activity)
            ...
            .setImageEngine(com.tzh.baselib.util.picture.GlideEngine.createGlideEngine())
